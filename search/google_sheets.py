...
fifth_account = gspread.service_account("fifth.json")
fifth_table = fifth_account.open(TABLE)

fifth_posts = fifth_table.worksheet("posts")
fifth_channels = fifth_table.worksheet("channels")
fifth_titles = fifth_table.worksheet("person")


sixth_account = gspread.service_account("sixth.json")
sixth_table = sixth_account.open(TABLE)

sixth_posts = sixth_table.worksheet("posts")
sixth_channels = sixth_table.worksheet("channels")
sixth_titles = sixth_table.worksheet("person")


channels_list = [first_channels, second_channels, third_channels, fourth_channels, fifth_channels, sixth_channels]
channel_cnt = 0
...
posts_list = [first_posts, second_posts, third_posts, fourth_posts, fifth_posts, sixth_posts]
posts_cnt = 0
...
titles_list = [first_titles, second_titles, third_titles, fourth_titles, fifth_titles, sixth_titles]
titles_cnt = 0
